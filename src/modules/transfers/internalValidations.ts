    ...
    return new Promise((resolve) => {
        ...
        if (flagRateRequirement){
            ...
            const isRatePresent = fluentValidationInstance()
                ...
                .addUserFailureMessage("rate must be greater than or equalt to zero (0)")
                .isIgnorable()
                .logDetailed()
                .logDetailed()
        ...
        const isAmountPresent = fluentValidationInstance()
            ...
            .isGreaterThan(0)
            .addUserFailureMessage("Transaction amount must be greater zero (0)")
            .logDetailed()
        ...
        const isRecipientCountryPresent = new ObjectHelpersFluent()
            ...
            // .isIgnorable()
            .logDetailed()
        isRecipientCountryPresent.failureCallBack(() => Toast.error("Country of recipient is missing"))
